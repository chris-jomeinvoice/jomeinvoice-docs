...
Created at Jome (Manual Creation)

Uploaded at Jome (Direct Upload)
...
[https://app.supademo.com/demo/cmq41uw4w1ogkqm6udmtbkq07?utm_source=link](https://app.supademo.com/demo/cmq41uw4w1ogkqm6udmtbkq07?utm_source=link)
...
2. **Click the red+button**
  The red **+** button is in the module header. Click it to open a new blank invoice form.
    *[Screenshot: Sales or Self-Billed module header with red + button]*
3. **Fill in issuer and invoice details**
  ...
  - **Issuing branch** — defaults to HQ. Change if this transaction belongs to a different branch.
    *[Screenshot: Invoice header form — issuer details and invoice-level fields]*
4. **Select the billing customer**
  Click the customer dropdown and search by **name**, **customer code**, or **TIN**. JomeInvoice shows matching records from your CRM as you type.
    ...
    *[Screenshot: Customer search dropdown showing CRM results]*
5. **Add line items**
  ...
  - **Tax rate** — must match the rates allowed for the selected classification code
    ...
    *[Screenshot: Line item table with classification typeahead open]*
